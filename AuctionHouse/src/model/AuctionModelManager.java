...
public class AuctionModelManager implements AuctionModel
{
  ...
  @Override public boolean placeBid(int bid, String bidder)
  {
  ...
  @Override public int getCurrentBid()
  {
    return auctionItem.getCurrentBid();
  }

  @Override public String getCurrentBidder()
  {
    return auctionItem.getCurrentBidder();
  }

  @Override public int getRemainingTimeInSeconds()
  {
